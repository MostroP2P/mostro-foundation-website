  ...
  <div class="bg-white py-20">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-2xl lg:text-center">
        <p class="text-lg/7 font-semibold text-primary-500">
          About Mostro
        </p>
        <div class="flex gap-4 items-center justify-center">
          <h2 class="mt-2 text-pretty text-5xl font-semibold tracking-tight text-tertiary-900 sm:text-6xl lg:text-balance">
            Why Mostro impacts
          </h2>
          <img
            class="size-14"
        ...
        <p class="mt-6 text-xl/8 text-tertiary-600">
      ...
      <div class="mx-auto mt-16 max-w-2xl lg:max-w-4xl">
        <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
          <div class="relative pl-16">
            <dt class="text-lg/7 font-semibold text-tertiary-900">
            ...
            <dd class="mt-2 text-lg/7 text-tertiary-600 font-light">
      ...
      <div class="flex flex-col gap-y-4 items-center justify-center pt-8 md:pt-16">
        <p class="text-tertiary-600 font-light text-xl">
